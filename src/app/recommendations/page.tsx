    ...
    return(
        <div className = 'mt-24 flex flex-col gap-8 items-center'>
            ...
            <div className = 'flex flex-col items-center gap-4 w-full'>
                {pieces.map(piece => <ScoreItem key = {piece.link} composer = {piece.composer} date = {piece.date} instrument = {piece.instrument} link = {piece.link} period = {piece.period}></ScoreItem> )}
            </div>
